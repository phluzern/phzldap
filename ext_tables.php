...
if (TYPO3_MODE == 'BE') {
	$TBE_MODULES_EXT['xMOD_db_new_content_el']['addElClasses']['tx_phzldap_pi2_wizicon'] = t3lib_extMgm::extPath($_EXTKEY).'pi2/class.tx_phzldap_pi2_wizicon.php';
}
if (TYPO3_MODE == 'BE') {
	$TBE_MODULES_EXT['xMOD_db_new_content_el']['addElClasses']['tx_phzldap_pi3_wizicon'] = t3lib_extMgm::extPath($_EXTKEY).'pi3/class.tx_phzldap_pi3_wizicon.php';
}
